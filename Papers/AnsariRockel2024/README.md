...
- [ClaytonResults.lean](ClaytonResults.lean): both CDF branches, special/limiting cases, positive-parameter CI, negative-parameter CD, and signed quadrant dependence.
