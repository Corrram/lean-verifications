...
- [ClaytonDensityDerivative.lean](ClaytonDensityDerivative.lean): first and mixed derivatives of the positive Clayton CDF formula and the exact pinned candidate-density integral and equality to actual copula mass on positive unit-square rectangles, with quantitative cutoff bounds and convergence to each upper-corner Clayton CDF; global measure equality remains open.
