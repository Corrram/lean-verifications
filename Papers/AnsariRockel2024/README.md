...
- [ClaytonDensityDerivative.lean](ClaytonDensityDerivative.lean): first and mixed derivatives of the positive Clayton CDF formula, matching the MTP2 density candidate pointwise; measure equality remains open.
