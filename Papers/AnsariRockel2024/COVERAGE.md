...
| Table 3: positive Clayton density on positive rectangles | `Papers.AnsariRockel2024.clayton_density_formula_integral_second`; `Papers.AnsariRockel2024.clayton_cdf_formula_integral_first`; `Papers.AnsariRockel2024.clayton_density_formula_positive_rectangle`; `Papers.AnsariRockel2024.clayton_density_formula_positive_rectangle_eq_measure` | verified | The analytic candidate integrates over every rectangle bounded away from both axes to the four-corner CDF increment and the actual copula measure of that rectangle. The one-coordinate FTC identities are also checked. Boundary passage and global measure equality remain pending. |
