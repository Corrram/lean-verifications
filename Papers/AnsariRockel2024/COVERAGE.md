...
| Table 3: negative Clayton CD | `Papers.AnsariRockel2024.clayton_negative_cd` | verified | Every θ in [−1,0) is conditionally decreasing in both directions on the closed square. The library proof establishes convexity of each CDF section, including the truncation boundary, and uses Archimedean symmetry. Reverse exclusions and density TP2 are not claimed here. |
