...
| Table 3: positive Clayton density TP2 | — | pending | The pinned copula package proves that the standard candidate formula is measurable, nonnegative, and MTP2. Its pointwise identification as the mixed derivative of the analytic CDF is now proved. Integrability and equality of lower-orthant integrals with the actual copula CDF remain pending, so `HasMTP2Density` is not claimed. |
