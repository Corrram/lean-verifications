...
| Table 3: positive Clayton quadrant dependence | `Papers.AnsariRockel2024.clayton_positive_pqd` | verified | Every θ>0 has C(u,v)≥uv on the closed square. This is a consequence expected from the printed CI entry, but does not verify CI or density TP2 themselves. The proof lives in the pinned copula package. |
