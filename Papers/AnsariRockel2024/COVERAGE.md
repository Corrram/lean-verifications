...
| Table 3: positive Clayton density TP2 | — | pending | The pinned copula package proves that the standard candidate formula is measurable, nonnegative, and MTP2. It has not yet proved that this formula integrates to the Clayton copula CDF, so `HasMTP2Density` is not claimed. |
