...
| Propositions 2-4 / Remark 3: remaining family properties | — | pending | Absolute continuity and the explicit density/support, uniform limiting cases, parameter ordering, MTP2, and general family symmetry/source-reflection correspondence. SI alone is verified above. |
...
| Example 1: PLOD does not imply xi<=rho | — | pending | Identify the displayed shuffle, prove PLOD, and evaluate xi=1 and rho=13/16. |
