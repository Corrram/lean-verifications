...
- [OptimizerUniqueness.lean](OptimizerUniqueness.lean): unique upper-boundary copulas and agreement at arc junctions.
- [DirectionalCompactness.lean](DirectionalCompactness.lean): full xi-eta region compactness and attained upper maxima.
...
- [EarlierCurve.lean](EarlierCurve.lean): all equality and strict comparison cases in Remark 1.4.
- [AsymptoticRankings.lean](AsymptoticRankings.lean): both finite-ranking bounds are asymptotically sharp at every admissible mean.
