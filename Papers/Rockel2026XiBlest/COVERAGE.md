...
| Source result | Lean declaration | Status | Hypotheses and scope |
| --- | --- | --- | --- |
| Revised Lemma cb_copula: absolute continuity and concrete density witness | `Papers.Rockel2026XiBlest.extremal_standardized_density`; `Papers.Rockel2026XiBlest.extremal_hasMTP2Density` | verified | The actual copula measure equals Lebesgue measure weighted by the standardized-band density. This gives absolute continuity and a measurable nonnegative density for every b>=0. The revision's derivative-based expression remains a separate obligation below. |
| Revised Lemma cb_copula: inverse derivative and density coefficient | `Papers.Rockel2026XiBlest.quadratic_switch_strict`; `Papers.Rockel2026XiBlest.extremalQ_interior`; `Papers.Rockel2026XiBlest.normalizationMean_deriv_neg_at_extremalQ`; `Papers.Rockel2026XiBlest.extremalQExtension_coe`; `Papers.Rockel2026XiBlest.extremalQExtension_hasDerivAt`; `Papers.Rockel2026XiBlest.extremalQExtension_density_coefficient` | verified | For every b>0 and interior v, the actual normalization inverse q has a nonzero derivative. The coefficient -b q'(v) equals the reciprocal length of the unclamped band. This is stronger than almost-everywhere differentiability but does not yet identify the density measure with the manuscript's displayed indicator formula. |
| Revised Lemma cb_copula: switching points and support | `Papers.Rockel2026XiBlest.extremalLowerSwitch_source`; `Papers.Rockel2026XiBlest.extremalUpperSwitch_source`; `Papers.Rockel2026XiBlest.extremal_switch_support` | verified | Both source switch-point expressions are identified with the reflected endpoints of the active clamped-square band, including the open support inequalities. |
| Revised Lemma cb_copula: derivative-formula candidate | `Papers.Rockel2026XiBlest.extremalDerivativeDensity_eq_width_of_interior`; `Papers.Rockel2026XiBlest.extremalDerivativeDensity_ae_eq_width`; `Papers.Rockel2026XiBlest.extremalWidthDensity_nonneg`; `Papers.Rockel2026XiBlest.extremalWidthDensity_measurable` | verified | The printed derivative expression equals a measurable, nonnegative reciprocal-width candidate almost everywhere; the excluded response endpoints have zero Lebesgue measure. This does not prove that either candidate is the actual copula density. |
| Revised Lemma cb_copula: displayed a.e. density as the actual copula measure | — | pending | The derivative expression and reciprocal-width candidate agree almost everywhere, and an MTP2 density exists. The remaining identity is equality of this candidate with the already verified standardized-band density (equivalently, equality of its withDensity measure with the copula measure). |
| Revised Proposition basic_properties_cb(i): MTP2 | `Papers.Rockel2026XiBlest.extremal_hasMTP2Density`; `Papers.Rockel2026XiBlest.signed_extremal_hasMTP2Density` | verified | Every finite positive member has a measurable nonnegative Lebesgue density satisfying MTP2 on the entire square; also covers the independence extension at zero. A fixed-width increasing band is standardized through its actual second marginal, and its copula is proved equal to the clamped extremal family. |
...
| Revised Proposition basic_properties_cb(iii): coefficient reflection | `Papers.Rockel2026XiBlest.signed_extremal_reflection_coefficients` | verified | For every b>0, the actual signed family has equal xi at b and -b and opposite Blest nu. |
