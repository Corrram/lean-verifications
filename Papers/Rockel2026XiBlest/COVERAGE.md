...
| Theorem 1.1: remaining boundary and full region | — | pending | Prove parameter exhaustion, the full explicit region, and maximal gap. The constructed family and its unique optimization bound are checked below. Closedness and abstract attainment of all slice extrema are separately verified below. |
