...
- [CountableOrdinalTail.lean](CountableOrdinalTail.lean): recursive tail decomposition and exact xi=footrule equality for adjacent countable Pi sums.
