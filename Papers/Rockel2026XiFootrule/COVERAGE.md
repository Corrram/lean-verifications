...
Every original named result in the corrected stated scope is matched to the final JCAM numbering in [SOURCE_COMPARISON.md](SOURCE_COMPARISON.md). Published Theorem 3.2 still says "unique real solution"; that unrestricted phrase is false, and Lean proves uniqueness only on [0,2].
